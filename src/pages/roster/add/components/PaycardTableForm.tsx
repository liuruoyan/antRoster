      ...
      render: (text: string, record: TableFormDateType) => {
        if (record.editable) {
          return (
            <Input
              value={text}
              onChange={e => this.handleFieldChange(e, 'branch', record.key)}
              onKeyPress={e => this.handleKeyPress(e, record.key)}
              placeholder="工分支行"
            />
          );
      ...
      render: (text: string, record: TableFormDateType) => {
        if (record.editable) {
          return (
            <Input
              value={text}
              onChange={e => this.handleFieldChange(e, 'bankAccount', record.key)}
              onKeyPress={e => this.handleKeyPress(e, record.key)}
              placeholder="工资卡银行账号"
            />
          );
      ...
      render: (text: string, record: TableFormDateType) => {
        if (record.editable) {
          return (
            <Input
              value={text}
              onChange={e => this.handleFieldChange(e, 'accountName', record.key)}
              onKeyPress={e => this.handleKeyPress(e, record.key)}
              placeholder="工资卡开户名"
            />
          );
